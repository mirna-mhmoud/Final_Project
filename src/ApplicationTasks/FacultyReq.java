 ...
 * @author hp
 */
public class FacultyReq extends Course implements CourseType {
    ...
    public FacultyReq(String c_id, String c_name, String lecturer, Time start, Time end, String room, String type) {
    ...
    public List<Course> getCourses() {
        ...
        try {
            ...
            String query = "select * from course c,lecture_data d,lecturer l where c.c_id=d.c_id "
                    + "and d.lecturer_id=l.lect_id and c.courseType='fa' and c.sem=20151 and state=0";
            ...
            while (set.next()) {
                course = new Course(set.getString("c_id"), set.getString("c_name"),
                        ...
                        set.getTime("startAt"), set.getTime("endAt"), set.getString("class"), "FA");
                courses.add(course);
            }
